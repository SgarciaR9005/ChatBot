...
begin
 ...
 // AgregarLineaMemo('3- ¿Deseas saber la cantidad de productos específicamente por sede?',clred);
end;
...
begin
    ...
    2: // Mostrar menú principal y procesar opción
      begin
        ...
        case Opcion of
         ...
         { 3  : begin
                 AgregarLineaMemo('Digite el código del producto que desea consultar:', clGreen);
                 Estado := 4;
               end;   }
        else
 ...
 {   4: // Procesar código de producto
      begin
        ...
        begin
          AgregarLineaMemo('Código de producto no válido. Por favor, intenta de nuevo.', clRed);
          Estado := 2; // Volver al menú principal
        end;
      end;  }
